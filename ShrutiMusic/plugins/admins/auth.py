...
@app.on_message(filters.command("yetkiver") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command("yetkial") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "yetkililer"]) & filters.group & ~BANNED_USERS
)
@language
