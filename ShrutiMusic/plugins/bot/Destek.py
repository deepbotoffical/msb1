...
SUDO_IDS = [7035704703]  # Ana Sudo ilk ID
...
# ==========================
# Kullanıcının mesajını alma (aktif talep varsa)
# ==========================
@app.on_message(filters.private & (filters.text | filters.photo | filters.document | filters.audio))
